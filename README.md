<picture>
  <img alt="John D. Gómez — Tech Lead, enterprise software design and evolution" src="https://assets.johndgomez.com/current/profiles/github/personal/png/banner.png" width="1280">
</picture>
...
**Software design.** Component responsibilities, dependencies and implementation trade-offs that teams can examine and act on.

**Systems integration.** Information contracts, business workflows and recovery from partial failures across applications.

**System evolution.** Incremental modernization, maintainability and the testing and delivery practices needed to change existing software with control.
...
[Career opportunities](mailto:career@johndgomez.com) · [Professional inquiries](mailto:contact@johndgomez.com)
